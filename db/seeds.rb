...
mac = Player.create(name: "Mac", league: league)
dennis = Player.create(name: "Dennis", league: league)
dee = Player.create(name: "Dee", league: league)
frank = Player.create(name: "Frank", league: league)
charlie = Player.create(name: "Charlie", league: league)
...
fooseball_game = Game.create(sport: fooseball, opponent: "Mac", date: "12/05/2017", arena: "Flatiron Stadium")
fooseball_game2 = Game.create(sport: fooseball, opponent: "Dennis", date: "12/06/2017", arena: "Flatiron Stadium")

mac_fooseball_game = PlayerGame.create(player: mac, game: fooseball_game, score: 10)
frank_fooseball_game = PlayerGame.create(player: frank, game: fooseball_game, score: 1)
